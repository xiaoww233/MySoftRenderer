...
public:
	...
	Model& getmodel();
	TGAImage& gettex();
	o2v MVPtrans(const Vec3f& worldcoord, const Vec3f& rotate_angle, const Vec3f& scale, const Vec3f& camera_coord, const Vec3f& camera_direction, const float& left, const float& right, const float& bottom, const float& top, const float& pnear, const float& pfar);
};
