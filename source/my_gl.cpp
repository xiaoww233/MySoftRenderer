...
o2v vertex_shader::MVPtrans(const Vec3f& worldcoord, const Vec3f& rotate_angle, const Vec3f& scale, const Vec3f& camera_coord, const Vec3f& camera_direction, const float& left, const float& right, const float& bottom, const float& top, const float& pnear, const float& pfar) {
	o2v result;
	...
	Matrix4x4f Matrix_P = view2cilp(left, right, bottom, top, pnear, pfar);
...
Matrix4x4f view2cilp(const float& left, const float& right, const float& bottom, const float& top, const float& near, const float& far, bool isperspective) {
	Matrix4x4f result;
